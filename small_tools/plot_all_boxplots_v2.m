...
TF_vortex = GBS_MERRA2_EWS.MERRA2_sPV_at_Theta490 >= 1.6e-4;
...
for i =1:5
    ...
    mean_delta_o3_table_allweather = grpstats(Table3,[],{'mean','std','sem','numel'},'DataVars',{'MERRA2_Ozone','delta_o3'});
    mean_delta_o3_table_allweather.weather_median_ampm = 'All';
    mean_delta_o3_table = [mean_delta_o3_table;mean_delta_o3_table_allweather];
...
autoticks = unique(Table3.weather_median_ampm);
for kk = numel(autoticks):1
    autoticks{kk+1} = autoticks{kk};
end
autoticks{1} = 'All';
xticklabels(autoticks);
xlabel('EWS reported weather');
...
for i =1:5
    ...
    mean_delta_o3_table_allweather = grpstats(Table3,[],{'mean','std','sem','numel'},'DataVars',{'mean_ColumnO3','delta_o3'});
    mean_delta_o3_table_allweather.weather_median_ampm = 'All';
    mean_delta_o3_table = [mean_delta_o3_table;mean_delta_o3_table_allweather];
